...
int main(){//arreglar no manda cadenas con espacios-si arregla lo de los espacios se chinga todo--ponle un comando de salida para que no tengas que cerrar la terminal
